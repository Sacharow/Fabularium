...
export default function PlayerView() {
    ...
    const STORAGE_KEY = "fabularium.campaigns.player_section"
    ...
    useEffect(() => {
        ...
        window.addEventListener('fabularium.players.updated', handler)
        return () => window.removeEventListener('fabularium.players.updated', handler)
    }, [])
