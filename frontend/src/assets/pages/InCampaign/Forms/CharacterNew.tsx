...
export default function CharacterNew() {
  ...
  const [skillProf, setSkillProf] =
    useState<Record<string, ProfLevel>>(INITIAL_SKILL_PROF);
  const [savingThrowProf, setSavingThrowProf] = useState<
    Record<string, ProfLevel>
  >({});
  ...
  const saveCharacter = () => {
    if (name.trim() === "") {
      ...
      try {
        ...
        try {
          window.dispatchEvent(new Event("fabularium.characters.updated"));
        } catch (e) {
          /* ignore */
        }
  ...
  const updateSkillProf = (skillName: string, newProf: ProfLevel) => {
    setSkillProf((prev) => {
      ...
      const next: Record<string, ProfLevel> = {
        ...prev,
      ...
      setStats((stPrev) =>
        stPrev.map((s) => {
          ...
          const newSkills = {
            ...s.skills,
            [skillName]: statModifier + profBonus * next[skillName],
          };
    ...
    setSavingThrowProf((prev) => {
      ...
      setStats((stPrev) =>
        stPrev.map((s) => {
          ...
          updated.modifier =
            Math.floor((updated.value - 10) / 2) +
            profBonus * (next[statName] ?? 0);
          return updated;
        }),
      );
      return next as Record<string, ProfLevel>;
  ...
  useEffect(() => {
    ...
    setHitPointsMax(
      hitDice + level * conMod + (level - 1) * Math.ceil((1 + hitDice) / 2),
    );
  }, [stats, hitDice, level]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-950 to-orange-900 pt-6">
                ...
                <ul className="space-y-2">
                  <li>
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded ${selectedView === "all" ? "bg-orange-700 text-white" : "text-orange-300 hover:bg-orange-800"}`}
                    >
                      All
                    </button>
                  </li>
                  <li>
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded ${selectedView === "basic" ? "bg-orange-700 text-white" : "text-orange-300 hover:bg-orange-800"}`}
                    >
                      Basic
                    </button>
                  </li>
                  <li>
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded ${selectedView === "lore" ? "bg-orange-700 text-white" : "text-orange-300 hover:bg-orange-800"}`}
                    >
                      Lore
                    </button>
                  </li>
                  <li>
                    <button
                      onClick={() => setSelectedView("gameplay")}
                      className={`w-full text-left px-3 py-2 rounded ${selectedView === "gameplay" ? "bg-orange-700 text-white" : "text-orange-300 hover:bg-orange-800"}`}
                    >
                      Gameplay
                    </button>
                  </li>
                  <li>
                    <button
                      onClick={() => setSelectedView("core")}
                      className={`w-full text-left px-3 py-2 rounded ${selectedView === "core" ? "bg-orange-700 text-white" : "text-orange-300 hover:bg-orange-800"}`}
                    >
                      Core
                    </button>
                  </li>
                  <li>
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded ${selectedView === "skills" ? "bg-orange-700 text-white" : "text-orange-300 hover:bg-orange-800"}`}
                    >
                      Skills
                    </button>
                  </li>
                  <li>
                    <button
                      onClick={() => setSelectedView("money")}
                      className={`w-full text-left px-3 py-2 rounded ${selectedView === "money" ? "bg-orange-700 text-white" : "text-orange-300 hover:bg-orange-800"}`}
                    >
                      Money
                    </button>
                  </li>
                  <li>
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded ${selectedView === "equipment" ? "bg-orange-700 text-white" : "text-orange-300 hover:bg-orange-800"}`}
                    >
                      Equipment
                    </button>
                  </li>
              ...
              {(selectedView === "all" || selectedView === "lore") && (
                <div className="bg-orange-700/30 p-4 rounded-md">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {/* Height */}
                    <div>
                      <p className={subTitleGameplayInformation}>Height</p>
                      <div className={inputGameplayInformation}>
                        <input
                          className="border-2 border-orange-700 rounded py-1 px-2 w-full bg-black text-white"
                          placeholder="180"
                    ...
                    {/* Weight */}
                    <div>
                      <p className={subTitleGameplayInformation}>Weight</p>
                      <div className={inputGameplayInformation}>
                        <input
                          className="border-2 border-orange-700 rounded py-1 px-2 w-full bg-black text-white"
                          placeholder="75"
                    ...
                    {/* Ideals */}
                    <div>
                      <p className={subTitleGameplayInformation}>Ideals</p>
                      <div className={inputGameplayInformation}>
                        <input
                          className="border-2 border-orange-700 rounded py-1 px-2 w-full bg-black text-white"
                    ...
                    {/* Bonds */}
                    <div>
                      <p className={subTitleGameplayInformation}>Bonds</p>
                      <div className={inputGameplayInformation}>
                        <input
                          className="border-2 border-orange-700 rounded py-1 px-2 w-full bg-black text-white"
                    ...
                    {/* Flaws */}
                    <div>
                      <p className={subTitleGameplayInformation}>Flaws</p>
                      <div className={inputGameplayInformation}>
                        <input
                          className="border-2 border-orange-700 rounded py-1 px-2 w-full bg-black text-white"
                ...
                <div className="bg-orange-700/30 p-4 rounded-md">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-orange-800/50 p-3 rounded">
                      <p className={subTitleGameplayInformation}>Level</p>
                      <div className={inputGameplayInformation}>
                        <input
                          type="number"
                          min={1}
                    ...
                    <div className="bg-orange-800/50 p-3 rounded">
                      <p className={subTitleGameplayInformation}>Background</p>
                      <div className={inputGameplayInformation}>
                        <select
                          className="border-2 border-orange-700 rounded py-1 px-2 w-full bg-black text-white"
                          value={background}
                ...
                <div className="bg-orange-700/30 p-4 rounded-md">
                  ...
                  <div className="grid grid-cols-3 grid-rows-2 gap-4 mb-6">
                    {stats.map((s) => (
                      <div
                        key={s.name}
                        className="bg-orange-800/50 p-3 rounded"
                      >
                  ...
                  <div className="border-2 border-orange-700 rounded py-1 px-2 w-full bg-black text-white min-h-20 grid grid-cols-4">
                    <div className="col-span-3">
                      ...
                      {equipment.map((item, index) => (
                        <div
                          key={index}
                          className="flex justify-between items-center border-b border-orange-700 py-1 w-9/10"
                        >
                          <p className="truncate">{item}</p>
                          <button
                            className="bg-red-600 hover:bg-red-500 text-white font-bold py-1 px-2 rounded cursor-pointer"
                    ...
                    <div className="col-span-1">
                      <button
                        className="bg-orange-600 hover:bg-orange-500 text-white font-bold py-2 px-4 rounded text-center cursor-pointer"
