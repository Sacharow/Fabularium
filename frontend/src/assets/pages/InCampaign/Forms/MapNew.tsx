    ...
    if (name.trim() === "") {
      ...
      try {
        const res = await fetch(
          `http://localhost:3000/api/campaigns/${campaignId}/maps`,
          {
            method: "POST",
        ...
        try {
          window.dispatchEvent(new Event("fabularium.maps.updated"));
        } catch (e) {
          /* ignore */
        }
        if (campaignId)
          navigate(`/InCampaign/${campaignId}/Maps/${created.id}`);
        else navigate(-1);
      } catch (e) {
    ...
    <div className="pt-6">
      <div className="w-full">
        ...
        <div className="grid grid-cols-8 gap-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded ${selectedView === "map" ? "bg-orange-700 text-white" : "text-orange-300 hover:bg-orange-800"}`}
                    >
                      Map
                    </button>
                  </li>
          ...
          <div className="col-span-2 w-full p-2"></div>
        </div>
      </div>
    </div>
  );
