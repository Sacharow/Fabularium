...
- Name: campaigns-and-characters.spec.ts >> Campaign Management >> should open campaign details on click
- Location: e2e\campaigns-and-characters.spec.ts:26:3
...
Expected substring: "/campaign"
Received string:    "http://localhost:5173/sign-in"
```
  ...
  - complementary [ref=e3]:
    - generic [ref=e4]:
      ...
      - generic [ref=e12]:
        ...
        - link "CAMPAIGNS" [active] [ref=e18] [cursor=pointer]:
          - /url: /campaigns
          - img [ref=e19]
