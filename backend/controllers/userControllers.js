...
const login = async (req, res) => {
    try {
        ...
        const { passwordHashed, ...safeUser } = user;
...
const getCurrentUser = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: "Błąd przy pobieraniu użytkownika", error: err });
    }
};

module.exports = {getAllUsers, createUserClassic, login, logout, refresh, getCurrentUser};