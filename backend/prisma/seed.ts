...
async function main() {
  ...
  const races = [
    ...
    },
    {
      ...
      subrace: { 
        name: "Hill Dwarf", 
        description: "Wise and sturdy.", 
        abilityBonuses: ability(0,0,1,0,1,0) 
      },
    ...
    },
    {
      ...
      subrace: { 
        name: "High Elf", 
        description: "Magically inclined.", 
        abilityBonuses: ability(0,0,0,1,0,0) 
      },
    ...
    },
    {
      ...
      subrace: { 
        ...
        abilityBonuses: ability(0,1,0,0,0,0) 
      },
    ...
    },
    {
      ...
      subrace: { 
        ...
        abilityBonuses: ability(1,1,0,0,0,0) 
      },
    ...
    },
    {
      ...
      subrace: { 
        name: "Lightfoot", 
        description: "Sneaky and charismatic.", 
        abilityBonuses: ability(0,0,0,0,0,1) 
      },
  ...
  const classes = [
    { name: "Barbarian", 
      hitDie: 12, 
      sub: "Berserker", 
      lvl1: ["Rage", "Unarmored Defense"] 
    },
    { name: "Bard", 
      hitDie: 8, 
      sub: "College of Lore", 
      lvl1: ["Spellcasting", "Bardic Inspiration"] 
    },
    { name: "Cleric", 
      hitDie: 8, 
      sub: "Life Domain", 
      lvl1: ["Spellcasting", "Divine Domain"] 
    },
    { name: "Druid", 
      hitDie: 8, 
      sub: "Circle of the Land", 
      lvl1: ["Druidic", "Spellcasting"] 
    },
    { name: "Fighter", 
      hitDie: 10, 
      sub: "Champion", 
      lvl1: ["Fighting Style", "Second Wind"] 
    },
    { name: "Monk", 
      hitDie: 8, 
      sub: "Way of Shadow", 
    ...
    { name: "Paladin", 
      hitDie: 10, 
      sub: "Oath of Devotion", 
      lvl1: ["Divine Sense", "Lay on Hands"] 
    },
    { name: "Ranger", 
      hitDie: 10, 
      sub: "Hunter", 
      lvl1: ["Favored Enemy", "Natural Explorer"] 
    },
    { name: "Rogue", 
      hitDie: 8, 
      sub: "Thief", 
      lvl1: ["Expertise", "Sneak Attack"] 
    },
    { name: "Sorcerer", 
      hitDie: 6, 
      sub: "Draconic Bloodline", 
      lvl1: ["Spellcasting", "Sorcerous Origin"] 
    },
    { name: "Warlock", 
      hitDie: 8, 
      sub: "Fiend Patron", 
      lvl1: ["Otherworldly Patron", "Pact Magic"] 
    },
    { name: "Wizard", 
      hitDie: 6, 
      sub: "Evocation School", 
      lvl1: ["Spellcasting", "Arcane Recovery"] 
    }
  ];
            ...
            features: {
              create: [
                { level: 3, 
                  ...
                  description: `First feature of ${c.sub}.` 
                }
              ]
            }
          }
